...
function finity.new(isdark, gprojectName, thinProject)
	...
	function self2:Category(name)
		...
		if firstCategory then
			...
			finity.gs["TweenService"]
				:Create(category.container, TweenInfo.new(0.3), { ScrollBarImageTransparency = 0 })
				:Play()
		end
		...
		category.button.MouseEnter:Connect(function()
			finity.gs["TweenService"]
				:Create(category.button, TweenInfo.new(0.2), { BackgroundTransparency = 0.5 })
				:Play()
		end)
		...
		category.button.MouseButton1Down:Connect(function()
				...
				if categoryf:IsA("ScrollingFrame") then
					if categoryf ~= category.container then
						finity.gs["TweenService"]
							...
							:Play()
						finity.gs["TweenService"]
							:Create(categoryf, TweenInfo.new(0.3), { ScrollBarImageTransparency = 1 })
							:Play()
					end
				end
			end
			...
			finity.gs["TweenService"]
				:Create(category.button, TweenInfo.new(0.2), { BackgroundTransparency = 0.2 })
				:Play()
			finity.gs["TweenService"]:Create(category.hider, TweenInfo.new(0.3), { BackgroundTransparency = 1 }):Play()
			finity.gs["TweenService"]
				:Create(category.container, TweenInfo.new(0.3), { ScrollBarImageTransparency = 0 })
				...
				if kind then
					if string.lower(kind) == "checkbox" or string.lower(kind) == "toggle" then
						...
						cheat.checkboxbutton.MouseEnter:Connect(function()
							...
							finity.gs["TweenService"]
								:Create(cheat.outerbox, TweenInfo.new(0.2), { ImageColor3 = lightertheme })
								:Play()
						end)
						cheat.checkboxbutton.MouseLeave:Connect(function()
							if not cheat.value then
								finity.gs["TweenService"]
									:Create(cheat.outerbox, TweenInfo.new(0.2), { ImageColor3 = theme.checkbox_outer })
									:Play()
							else
								finity.gs["TweenService"]
									:Create(
					...
					elseif string.lower(kind) == "color" or string.lower(kind) == "colorpicker" then
						...
						cheat.hsvbar.MouseButton1Down:Connect(function()
							...
							while uis:IsMouseButtonPressed("MouseButton1") do
								...
								local position = math.clamp(offset, -sx, cheat.hsvbar.AbsoluteSize.X - sx)
					...
					elseif string.lower(kind) == "dropdown" then
						...
						local function refreshOptions()
							...
							for _, value in next, options do
								...
								button.MouseEnter:Connect(function()
									finity.gs["TweenService"]
										:Create(button, TweenInfo.new(0.1), { TextColor3 = theme.dropdown_text_hover })
										:Play()
								end)
								button.MouseLeave:Connect(function()
									finity.gs["TweenService"]
										:Create(button, TweenInfo.new(0.1), { TextColor3 = theme.dropdown_text })
										:Play()
								end)
								...
								:Create(
									...
									TweenInfo.new(0),
									{
										...
										CanvasSize = UDim2.new(
											...
											0,
											0,
											cheat.list["UIListLayout"].AbsoluteContentSize.Y
										),
										ScrollBarImageTransparency = 1,
										BackgroundTransparency = 1,
									}
						...
						cheat.dropdown.MouseEnter:Connect(function()
							finity.gs["TweenService"]
								:Create(cheat.selected, TweenInfo.new(0.1), { TextColor3 = theme.dropdown_text_hover })
								:Play()
						end)
						cheat.dropdown.MouseLeave:Connect(function()
							finity.gs["TweenService"]
								:Create(cheat.selected, TweenInfo.new(0.1), { TextColor3 = theme.dropdown_text })
								:Play()
						end)
					...
					elseif string.lower(kind) == "textbox" then
						...
						cheat.background.MouseEnter:Connect(function()
							finity.gs["TweenService"]
								:Create(cheat.textbox, TweenInfo.new(0.1), { TextColor3 = theme.textbox_text_hover })
								:Play()
						end)
						cheat.background.MouseLeave:Connect(function()
							finity.gs["TweenService"]
								:Create(cheat.textbox, TweenInfo.new(0.1), { TextColor3 = theme.textbox_text })
								:Play()
						end)
					...
					elseif string.lower(kind) == "slider" then
						...
						cheat.sliderbar.MouseButton1Down:Connect(function()
							...
							finity.gs["TweenService"]
								:Create(cheat.visiframe, TweenInfo.new(0.1), {
							...
							finity.gs["TweenService"]
								:Create(cheat.numbervalue, TweenInfo.new(0.1), {
					...
					elseif string.lower(kind) == "button" then
						...
						cheat.button.MouseLeave:Connect(function()
							finity.gs["TweenService"]
								:Create(cheat.background, TweenInfo.new(0.2), { ImageColor3 = theme.button_background })
								:Play()
						end)
					...
					elseif string.lower(kind) == "keybind" or string.lower(kind) == "bind" then
						...
						cheat.button.MouseButton1Up:Connect(function()
							...
							connection = finity.gs["UserInputService"].InputBegan:Connect(function(Input)
								if
									Input.UserInputType.Name == "Keyboard"
									and Input.KeyCode ~= finityData.ToggleKey
